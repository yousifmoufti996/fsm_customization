...
class FSMOrder(models.Model):
    ...
    latitude1 = fields.Float('Latitude',related='customer_id.partner_latitude',digits=(23, 20))
    longitude1 = fields.Float('Longitude',related='customer_id.partner_longitude',digits=(23, 20))
